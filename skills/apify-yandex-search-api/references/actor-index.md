...
|-------------|----------|-------|
| Alternative billing for Yandex snapshots | `johnvc/yandex-scrape-yandex-search-results-at-scale---per-result` | Alternative billing edition; scheduled tracking still requires stored snapshots and comparison. |
...
2. Fetch the input schema: `apify actors info "johnvc/Scrape-Yandex" --input 2>/dev/null`
